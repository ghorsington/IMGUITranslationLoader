...
set hook=IMGUITranslationLoader.Hook
set plugin=IMGUITranslationLoader.Plugin
set patchersybaris=IMGUITranslationLoader.Sybaris.Patcher
set patcherrei=IMGUITranslationLoader.Patch
